...
class DQN:
    ...
    def _update_behavior_network(self, gamma):
        ...
        with torch.no_grad():
            ...
            q_target = reward + gamma * q_next * (1 - done)  # 最大值在[0] 索引在[1]
...
def train(args, agent, writer):
    ...
    env = wrap_deepmind(env_raw, True, True, True)
    ...
    for episode in range(args.episode):
        ...
        for t in itertools.count(start=1):
            ...
            if done:
                ...
                writer.add_scalar('Train/Episode Reward',
    ...
    for i in range(args.test_episode):
        ...
        while not done:
            ...
            action = agent.select_action(
                state, args.test_epsilon, action_space)
...
def main():
    ...
    parser.add_argument('-tmp', '--test_model_path',
                        default='ckpt/dqn_1000000.pt')
